<template >
  <form id="formulaire" autocomplete="off" @submit.prevent="$emit('article-submitted', formContent)">
    <label for="nom">Nom de l'article : </label><br>
    <input v-model="formContent.nom" type="text" name="nom" id="nom" required><br>
    ...
    <input v-model="formContent.prix" type="number" min="0" step="0.5" name="prix" id="prix"><br>
